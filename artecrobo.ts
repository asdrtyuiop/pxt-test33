...
namespace artecrobo {
    ...
    */
	...
	//% block group="Sensor"
	//% blockId=robotbit_ultrasonic block="Ultrasonic|pin %_connector|"
    //% weight=10
    export function Ultrasonic(_connector: DigitalPin): number {
        return UltrasonicVer(_connector, SonarVersion.V1);
    }
